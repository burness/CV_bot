...
tf.app.flags.DEFINE_string('image_dir', '/Users/burness/git_repository/CV_bot/data/new',
...
tf.app.flags.DEFINE_integer('save_step_interval', 1000,
                            """How often to evaluate the training results.""")
...
tf.app.flags.DEFINE_string('model_dir', '/Users/burness/git_repository/CV_bot/data/model_data',
...
def main(_):
    ...
    for i in range(FLAGS.how_many_training_steps):
        ...
        if (i % FLAGS.save_step_interval) == 0 or is_last_step:
            ...
            with gfile.FastGFile(FLAGS.output_graph+str(i), 'wb') as f:
                f.write(output_graph_def.SerializeToString())
            with gfile.FastGFile(FLAGS.output_labels+str(i), 'w') as f:
